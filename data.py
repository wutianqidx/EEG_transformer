...
class EEGDataset(Dataset):
    ...
    def get_eeg(self, idx):
        ...
        return torch.tensor(reshape_eeg), len(reshape_eeg)
    ...
    def __getitem__(self, idx):
        ...
        """
        eeg, length = self.get_eeg(idx)
        report, length_t = self.get_text(idx)
        return eeg, report, length, length_t
