...
if __name__ == '__main__':
	...
	pickle.dump((data[:train_len], word_bag, freq), open("eeg_text_train.pkl", "wb"))
	pickle.dump((data[train_len:train_len+val_len], word_bag, freq), open("eeg_text_val.pkl", "wb"))
	pickle.dump((data[train_len+val_len:], word_bag, freq), open("eeg_text_test.pkl", "wb"))
